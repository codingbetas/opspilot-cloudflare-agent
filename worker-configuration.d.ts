/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a6983d395bbfd7aa055f43e17f133343)
// Runtime types generated with workerd@1.20260918.1 2026-08-10 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	OpsPilotAgent: DurableObjectNamespace<import("./src/server").OpsPilotAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "OpsPilotAgent";
	}
